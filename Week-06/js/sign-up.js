window.onload = function(){
    ...
    function send(e){
        ...
        requestValue(inputName.value, inputSurname.value, inputID.value, newDate,
    ...
    var inputID = document.getElementById('input-id');
        function myFocusFunctionID() {
            dataSend.style.visibility= "hidden";
            var validation= validationID(inputSurname);

            if(validation){
                inputID.style.backgroundColor = "white";
                inputID.style.border =  "1px solid #373867";
            } else{
                inputID.style.backgroundColor = "white";
                inputID.style.border =  "1px solid #373867";
            }
        }
        function myBlurFunctionID() {

            var validation= validationID(inputID);

            if(validation){
                inputID.style.border =  "1px solid #373867";
                error[2].style.visibility= "hidden";
            }else{
                inputID.style.border = "solid 1px #B20600";
                error[2].style.visibility= "visible";
            }
        }
    inputID.addEventListener("focus", myFocusFunctionID);
    inputID.addEventListener("blur", myBlurFunctionID);
    inputID.addEventListener('keydown', validateChars);
